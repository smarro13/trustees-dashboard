...
export const CLUB_REFRESH_JOBS: ClubRefreshJob[] = [
  // Eric Evans Lounge
  {
    area: 'Eric Evans Lounge',
    job: 'Repair plaster around door',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Plaster/filler, sandpaper, caulk, paint, brushes',
  },
  {
    area: 'Eric Evans Lounge',
    job: 'Improve MPI Cup display',
    category: 'Aesthetic',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Shelving, display mounts, lighting, cleaning materials',
  },
  {
    area: 'Eric Evans Lounge',
    job: 'Add display lighting',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Low',
    materials: 'LED lights, cable clips, electrical fixings',
  },
  {
    area: 'Eric Evans Lounge',
    job: 'Review TV positioning',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Low',
    materials: 'TV brackets, wall fixings, cable trunking',
  },
  // Foyer
  {
    area: 'Foyer',
    job: 'Repaint or wallpaper (skim if needed)',
    category: 'Decoration',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Paint, wallpaper, filler, rollers, brushes',
  },
  {
    area: 'Foyer',
    job: 'Remove posters and frames',
    category: 'Aesthetic',
    status: 'Not Started',
    priority: 'Low',
  ...
  {
    area: 'Foyer',
    job: 'Clean/review plex displays',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Glass cleaner, cloths, cleaning products',
  },
  // Ladies Toilets
  {
    area: 'Ladies Toilets',
  ...
  {
    area: 'Gents Toilets',
    job: 'Repair hand dryer',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'High',
    materials: 'Replacement parts or new dryer, screws, fixings',
  },
  {
    area: 'Gents Toilets',
    job: 'Fix paper towel supply',
    category: 'Maintenance',
    status: 'Not Started',
    priority: 'High',
    materials: 'New dispenser, screws, wall plugs',
  },
  {
    area: 'Gents Toilets',
    job: 'Improve LED lighting in toilet foyer',
    category: 'Electrical',
    status: 'Not Started',
    priority: 'High',
    materials: 'LED fittings, bulbs, wiring accessories',
  },
  {
    area: 'Gents Toilets',
    job: 'Repair dented door',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Wood filler, sandpaper, paint',
  },
  {
    area: 'Gents Toilets',
    job: 'Re-plaster damaged areas',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Plaster, filler, scrim tape, sanding materials',
  },
  {
    area: 'Gents Toilets',
    job: 'Remove signage & repaint',
    category: 'Decoration',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Paint, rollers, brushes, filler',
  },
  {
    area: 'Gents Toilets',
    job: 'Fix cubicle lock alignment',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'High',
    materials: 'Locks, screws, hinges, hand tools',
  },
  {
    area: 'Gents Toilets',
    job: 'Replace/reseal shelf',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Timber, sealant, screws, brackets',
  },
  {
    area: 'Gents Toilets',
    job: 'Remove sanitiser station',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Hand tools, filler, paint for making good',
  },
  // Function Room
  {
    area: 'Function Room',
    job: 'Fix lighting issue (too bright or pitch black)',
    category: 'Electrical',
    status: 'Not Started',
    priority: 'High',
    materials: 'Dimmer/switches, LED fittings, electrical parts',
  },
  {
    area: 'Function Room',
    job: 'Repair flooring',
  ...
  {
    area: 'Function Room',
    job: 'Repaint whole room - brighter',
    category: 'Decoration',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Paint, rollers, brushes, dust sheets',
  },
  {
    area: 'Function Room',
    job: 'Redesign signage',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Signs, vinyl, frames, fixings',
  },
  {
    area: 'Function Room',
    job: 'Replace curtains for larger ones/doors',
    category: 'Aesthetic',
    status: 'Not Started',
    priority: 'Low',
  ...
  {
    area: 'Function Room',
    job: 'Review wall displays and pictures',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Frames, wall fixings, signage materials',
  },
  {
    area: 'Function Room',
    job: 'Improve room decoration and branding',
    category: 'Aesthetic',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Club artwork, vinyls, frames, wall fixings',
  },
  {
    area: 'Function Room',
    job: 'Repair/replace damaged skirting and trim',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Timber, filler, screws, paint',
  },
  {
    area: 'Function Room',
    job: 'Deep clean throughout',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Cleaning products, cloths, mops, buckets',
  },
  {
    area: 'Function Room',
    job: 'Review furniture layout and condition',
    category: 'Organisation',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Furniture pads, fixings, minor repair materials',
  },
  {
    area: 'Corridors',
    job: 'Repaint corridor areas',
    category: 'Decoration',
    status: 'Not Started',
    priority: 'Medium',
  ...
  {
    area: 'Corridors',
    job: 'Improve corridor lighting',
    category: 'Electrical',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'LED fittings, bulbs, electrical accessories',
  },
  {
    area: 'Corridors',
    job: 'Remove old notices and improve appearance',
    category: 'Aesthetic',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Scrapers, filler, paint, frames',
  },
  {
    area: 'Changing Rooms',
    job: 'Full repaint of changing rooms',
    category: 'Decoration',
    status: 'Not Started',
    priority: 'High',
    materials: 'Hardwearing paint, rollers, brushes, trays, dust sheets',
  },
  {
    area: 'Changing Rooms',
    job: 'Remove old notices, tape and damaged signage',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Scrapers, adhesive remover, filler, sandpaper, paint',
  },
  {
    area: 'Changing Rooms',
  ...
  {
    area: 'Changing Rooms',
    job: 'Remove redundant equipment and clutter',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Waste bags, storage boxes, gloves',
  },
  {
    area: 'Changing Rooms',
    job: 'Repair damaged walls and surfaces',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Filler, plaster, sandpaper, paint',
  },
  {
    area: 'Changing Rooms',
    job: 'Improve storage areas',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Shelving, brackets, storage containers',
  },
  {
    area: 'Changing Rooms',
    job: 'Deep clean changing areas',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Cleaning chemicals, brushes, mops, PPE',
  },
  {
  ...
  {
    area: 'New Changing Area',
    job: 'Secure and improve emergency exit area',
    category: 'Safety',
    status: 'Not Started',
    priority: 'High',
  ...
  {
    area: 'New Changing Area',
    job: 'Deep clean and organise',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Cleaning materials, storage boxes, labels',
  },
  {
    area: 'Gym',
    job: 'Replace damaged flooring/tiles',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'High',
    materials: 'Rubber flooring, tiles, adhesive, cutting tools',
  },
  {
    area: 'Gym',
    job: 'Repaint walls',
  ...
  {
    area: 'Gym',
    job: 'Service and repair equipment',
    category: 'Maintenance',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Lubricants, replacement parts, hand tools',
  },
  {
    area: 'Gym',
    job: 'Install new leg curl machine',
    category: 'Equipment',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Fixings, protective flooring, moving equipment',
  },
  {
    area: 'Gym',
    job: 'Improve storage and organisation',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Racks, hooks, storage boxes',
  },
  {
    area: 'Gym',
    job: 'Deep clean gym area',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Cleaning sprays, cloths, disinfectant',
  },
  {
    area: 'External Areas',
    job: 'Remove weeds and tidy borders',
    category: 'Grounds',
    status: 'Not Started',
    priority: 'High',
  ...
  {
    area: 'External Areas',
    job: 'Jet wash patios, paths and hard standing',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Pressure washer, detergents, hoses',
  },
  {
    area: 'External Areas',
    job: 'Remove waste, rubbish and scrap materials',
    category: 'Clearance',
    status: 'Not Started',
    priority: 'High',
    materials: 'Skips, rubble bags, gloves, lifting equipment',
  },
  {
    area: 'External Areas',
    job: 'Repair/replace damaged decking',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Timber boards, decking screws, timber treatment, saws',
  },
  {
    area: 'External Areas',
    ...
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Ladders, gutter brackets, replacement sections, sealant',
  },
  {
    area: 'External Areas',
    job: 'Repaint external walls, fencing and bollards',
    category: 'Decoration',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Exterior paint, rollers, brushes, sandpaper',
  },
  {
    area: 'External Areas',
    job: 'Replace artificial grass entrance area',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Artificial grass, adhesive, edging strips',
  },
  {
    area: 'External Areas',
    job: 'Clean and restore memorial plaques',
    category: 'Cleaning',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Specialist metal cleaner, cloths, protective polish',
  },
  {
    area: 'External Areas',
    job: 'Remove, move or reorganise storage containers',
    category: 'Clearance',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Lifting equipment, skips, chains, cutting tools',
  },
  {
    area: 'External Areas',
    job: 'Secure and tidy external cabling/services',
    category: 'Safety',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Cable clips, conduit, fixings, electrical materials',
  },
  {
    area: 'External Areas',
    job: 'General grass cutting and edging',
    category: 'Grounds',
    status: 'Ongoing',
    priority: 'High',
    materials: 'Mower, strimmer line, fuel, PPE',
  },
  {
    area: 'External Areas',
    job: 'Remove moss from paths and surfaces',
    category: 'Grounds',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Moss treatment, stiff brushes, pressure washer',
  },
  {
    area: 'External Areas',
    job: 'Repair damaged fencing and gates',
    category: 'Repairs',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Timber, posts, hinges, screws, concrete',
  },
  {
    area: 'External Areas',
    job: 'Clean and organise external storage areas',
    category: 'Clearance',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Storage boxes, shelving, bags, gloves',
  },
  {
    area: 'External Areas',
    job: 'Remove redundant materials and old equipment',
    category: 'Clearance',
    status: 'Not Started',
    priority: 'High',
    materials: 'Skip, rubble bags, gloves, lifting equipment',
  },
  {
    area: 'Safety',
    job: 'Restock first aid stations',
    category: 'Safety',
    status: 'Ongoing',
    priority: 'High',
  ...
  {
    area: 'Safety',
    job: 'Review and replace emergency signage',
    category: 'Safety',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Emergency signs, fixings, adhesive',
  },
  {
    area: 'Safety',
    ...
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Cleaning chemicals, cloths, disinfectant, PPE',
  },
  {
    area: 'Safety',
    ...
    status: 'Not Started',
    priority: 'High',
    materials: 'Emergency lighting units, batteries, electrical parts',
  },
  {
    area: 'Club Site & Wayfinding',
    job: 'Install club site map and visitor information board',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'Signboard, posts, concrete, fixings',
  },
  {
    area: 'Club Site & Wayfinding',
    job: 'Replace outdated internal/external signage',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Medium',
    materials: 'New signs, vinyl graphics, fixings',
  },
  {
    area: 'Club Site & Wayfinding',
    job: 'Remove old signage and make good',
    category: 'Decoration',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Tools, filler, paint, cleaning materials',
  },
  {
    area: 'Club Site & Wayfinding',
    job: 'Improve directional signage for visitors and events',
    category: 'Improvement',
    status: 'Not Started',
    priority: 'Low',
    materials: 'Directional signs, posts, vinyl, fixings',
  },
];
